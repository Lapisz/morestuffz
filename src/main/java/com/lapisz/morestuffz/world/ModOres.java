package com.lapisz.morestuffz.world;
...
public class ModOres implements IWorldGenerator {
	...
	private void generateOverworld(Random random, int chunkX, int chunkZ, World world) {
		//Over world Ores
		addOre(MBlocks.SapphireOre, Blocks.stone, random, world, chunkX, chunkZ, 3, 50, 3, 9, 30);
		addOre(MBlocks.RubyOre, Blocks.stone, random, world, chunkX, chunkZ, 3, 50, 3, 9, 30);
	}
